...
const ICON_NAMES = 'add,add_circle,apartment,architecture,arrow_back,arrow_forward,arrow_outward,assignment,attach_file,bar_chart,bathtub,bed,business_center,call,chair,chat_bubble,check,check_circle,checklist,chevron_left,chevron_right,close,construction,content_copy,countertops,dashboard,delete,description,design_services,difference,directions_car,domain,download,drag_indicator,edit,edit_square,error,expand_less,expand_more,fact_check,favorite,file_copy,flip,floor_lamp,forum,garage_home,gavel,grid_view,groups,history,home,home_work,image,image_not_supported,inbox,info,ios_share,key,landscape,list,location_on,lock,logout,mail,mark_email_read,menu,more_vert,palette,person,photo_library,picture_as_pdf,print,progress_activity,radio_button_unchecked,real_estate_agent,receipt_long,refresh,restore,save,school,search,settings,shower,square_foot,star,support_agent,terrain,touch_app,unfold_more,verified_user,visibility,visibility_off,warning,weekend,zoom_in'
